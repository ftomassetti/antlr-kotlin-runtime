...
//    protected var _input: TokenStream
...
//            }
//        }
//        return if (alts.size() === 0) ATN.INVALID_ALT_NUMBER else alts.getMinElement()
//    }
//
...
//            if (returnState.stateType == BLOCK_END && returnStateTarget === p) {
//                continue
//            }
...
//            if (returnStateTarget.stateType == BLOCK_END &&
...
//        return if (parser != null && index >= 0) parser!!.getRuleNames()[index] else "<rule $index>"
//    }
//
//
...
//        }
//
//        val vocabulary = if (parser != null) parser!!.getVocabulary() else VocabularyImpl.EMPTY_VOCABULARY
//        val displayName = vocabulary.getDisplayName(t)
//        return if (displayName == Integer.toString(t)) {
//            displayName
//        } else displayName + "<" + t + ">"
//
//    }
...
//
//        if (debug) {
//            System.out.println("DFA=\n" + dfa.toString(if (parser != null) parser!!.getVocabulary() else VocabularyImpl.EMPTY_VOCABULARY))
//        }
//
//        return to
//    }
...
//        val TURN_OFF_LR_LOOP_ENTRY_BRANCH_OPT = java.lang.Boolean.parseBoolean(getSafeEnv("TURN_OFF_LR_LOOP_ENTRY_BRANCH_OPT"))
//
