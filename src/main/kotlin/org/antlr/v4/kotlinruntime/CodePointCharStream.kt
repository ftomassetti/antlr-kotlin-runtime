...
private constructor(position: Int, protected val size: Int, protected val name: String?) : CharStream {
    ...
    private class CodePoint8BitCharStream private constructor(position: Int, remaining: Int, name: String, private val byteArray: ByteArray, arrayOffset: Int) : CodePointCharStream(position, remaining, name) {
        ...
        override fun LA(i: Int): Int {
            ...
            when (Integer.signum(i)) {
                -1 -> {
                    ...
                    return if (offset < 0) {
                        IntStream.EOF
                    } else byteArray[offset] and 0xFF
                }
                0 ->
                    // Undefined
                    return 0
    ...
    private class CodePoint16BitCharStream private constructor(position: Int, remaining: Int, name: String, private val charArray: CharArray, arrayOffset: Int) : CodePointCharStream(position, remaining, name) {
    ...
    private class CodePoint32BitCharStream private constructor(position: Int, remaining: Int, name: String, private val intArray: IntArray, arrayOffset: Int) : CodePointCharStream(position, remaining, name) {
